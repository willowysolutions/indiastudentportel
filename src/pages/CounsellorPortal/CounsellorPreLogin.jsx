...
import PathImage from "../../assets/ISP_images/career_path.jpg";

function CounsellorPreLogin() {
  return (
      ...
      <section className="w-full px-8 text-gray-700 ">
        <div className="container flex flex-col flex-wrap items-center justify-between py-5 mx-auto md:flex-row max-w-7xl">
          <div className="inline-flex w-full justify-end ml-5 space-x-6">
            <a
              href="https://indiastudentportal-app.vercel.app/counsellor/login"
            ...
            <a
              href="https://indiastudentportal-app.vercel.app/counsellor/signup"
            ...
            <div className="w-full md:w-1/2 md:px-3">
              <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                ...
                <p className="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">
                  Guide students with personalized advice, analyze test results,
                  and recommend career-focused paths. Help them unlock their
                  potential and make informed decisions for their future.
                </p>
        ...
        <div className="box-border flex flex-col items-center content-center px-10 mx-auto leading-8 text-black border-0 border-gray-300 border-solid md:flex-row max-w-7xl lg:px-20">
          ...
          <div className="box-border w-full text-black md:w-1/2 md:pl-12 flex flex-col justify-center">
            ...
            <p className="pt-6 pb-10 text-lg leading-8 text-gray-700 sm:pr-16 xl:pr-40 lg:text-xl">
              Begin by reviewing the student’s details and aptitude test
              results. Analyze their strengths, interests, and career
              preferences to better understand their potential and guide them
              effectively.
            </p>
            <ul className="p-0 leading-7 lg:text-lg">
              <li className="flex items-start py-2 text-gray-600">
                ...
                Assess aptitude test results and student data.
              </li>
              <li className="flex items-start py-2 text-gray-600">
                <span className="flex items-center justify-center w-8 h-8 mr-3 text-white bg-custom-indigo rounded-full">
                  <span className="text-base font-bold">✓</span>
                </span>
                Identify key strengths and career interests.
              </li>
              <li className="flex items-start py-2 text-gray-600">
                <span className="flex items-center justify-center w-8 h-8 mr-3 text-white bg-custom-indigo rounded-full">
                  <span className="text-base font-bold">✓</span>
                </span>
                Determine areas that require further guidance.
              </li>
            </ul>
          </div>
          {/* End Content */}
            ...
            <div className="order-1 w-full px-3 lg:w-1/2 lg:order-0">
              ...
              <div className="w-full lg:max-w-md">
                ...
                <p className="mb-4 font-medium tracking-tight text-gray-400 xl:mb-6">
                  Conduct a one-on-one session with the student. Provide
                  tailored career advice, discuss their options, and help them
                  align their strengths with potential career paths and
                ...
                <ul>
                  <li className="flex items-center py-2 space-x-4 xl:py-3">
                    ...
                    <span className="font-medium text-gray-500">
                      Offer advice based on student’s results.
                    </span>
                  </li>
                  <li className="flex items-center py-2 space-x-4 xl:py-3">
                    <svg
                    ...
                    <span className="font-medium text-gray-500">
                      Discuss potential career and educational options.
                    </span>
                  </li>
                  <li className="flex items-center py-2 space-x-4 xl:py-3">
                    <svg
                    ...
                    <span className="font-medium text-gray-500">
                      Provide support and encouragement for informed decisions.
                    </span>
                  </li>
                </ul>
              </div>
      ...
      <section className="w-full pt-10 pb-10 md:pt-24 md:pb-28">
        <div className="box-border flex flex-col items-center content-center px-10 mx-auto leading-8 text-black border-0 border-gray-300 border-solid md:flex-row max-w-7xl lg:px-20">
          ...
          <div className="box-border w-full text-black md:w-1/2 md:pl-12 flex flex-col justify-center">
            ...
            <h2 className="m-0 text-2xl font-bold leading-tight lg:text-4xl md:text-3xl">
              Recommend Career and Educational Pathways
            </h2>
            <p className="pt-6 pb-10 text-lg leading-8 text-gray-700 sm:pr-16 xl:pr-40 lg:text-xl">
              After counseling, recommend suitable colleges or schools that
              align with the student’s career goals. Offer lifelong support to
              help them stay on track and adapt to future changes in their
              journey.
            </p>
            <ul className="p-0 leading-7 lg:text-lg">
              <li className="flex items-start py-2 text-gray-600">
                ...
                Suggest educational institutions aligned with goals.
              </li>
              <li className="flex items-start py-2 text-gray-600">
                <span className="flex items-center justify-center w-8 h-8 mr-3 text-white bg-custom-indigo rounded-full">
                  <span className="text-base font-bold">✓</span>
                </span>
                Provide long-term career support and guidance.
              </li>
              <li className="flex items-start py-2 text-gray-600">
                <span className="flex items-center justify-center w-8 h-8 mr-3 text-white bg-custom-indigo rounded-full">
                  <span className="text-base font-bold">✓</span>
                </span>
                Ensure students feel supported throughout their journey.
              </li>
            </ul>
          </div>
          {/* End Content */}
...
export default CounsellorPreLogin;
